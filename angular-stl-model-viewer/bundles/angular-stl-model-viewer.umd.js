(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('three'), require('three/examples/jsm/loaders/STLLoader'), require('three/examples/jsm/controls/OrbitControls')) :
    typeof define === 'function' && define.amd ? define('angular-stl-model-viewer', ['exports', '@angular/core', 'three', 'three/examples/jsm/loaders/STLLoader', 'three/examples/jsm/controls/OrbitControls'], factory) :
    (global = global || self, factory(global['angular-stl-model-viewer'] = {}, global.ng.core, global.three, global.STLLoader, global.OrbitControls));
}(this, (function (exports, core, three, STLLoader, OrbitControls) { 'use strict';
